      ...
      <div className="homelogomarket--content">
        ...
        <div className="content__bot">
          ...
          <div className="content__bot--right">
            <img
              src="https://fiverr-res.cloudinary.com/q_auto,f_auto,w_852,dpr_1.0/v1/attachments/generic_asset/asset/8610b9c7c90c338adc976e96051cbd6c-1608034070829/logo-maker-banner-tablet-852-2x.png"
              alt="#"
            />
          </div>
        </div>
