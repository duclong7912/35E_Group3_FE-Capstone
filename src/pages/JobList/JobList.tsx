...
import { UserSearch } from "../../Models/jobSearch/jobSearchModel";
import { DispatchType, StateType } from "../../redux/configStore";
import { getListByIdApi } from "../../redux/jobListReducer/jobListReducer";
import { jobSearchApi } from "../../redux/JobResultReducer/jobResultReducer";
...
const JobList = (props: Props) => {
  ...
  const { arrJobSearch } = useSelector(
    (state: StateType) => state.jobResultReducer
  );
  ...
  const getListByKeyword = () => {
    const keyword: string | undefined = param.keyword;
    const actionAsync = jobSearchApi(keyword);
    dispatch(actionAsync);
  };
  useEffect(() => {
    getListByKeyword();
  ...
  const handleRenderList = () => {
    if (arrJobSearch.length) {
      return arrJobSearch.map((list: UserSearch, index: number) => {
        return (
          <div key={index} className="service__col col-xl-3 col-lg-4 col-sm-6">
            <div className="service__card">
              ...
              <div className="service__seller">
                ...
                <div className="seller-info">
                  ...
                  <span>Level {list.congViec.saoCongViec} Seller</span>
                </div>
              </div>
              <div className="service__info">
                ...
                <div className="service__rate">
                  ...
                  <span className="amount-rate">({list.congViec.danhGia})</span>
                </div>
              </div>
              <div className="service__footer">
                ...
                <div className="service__price">
                  ...
                  <span className="price">US${list.congViec.giaTien}</span>
                </div>
              </div>
            </div>
          </div>
      ...
      return arrJobList.map((list: JobListModel, index: number) => {
        return (
          <div key={index} className="service__col col-xl-3 col-lg-4 col-sm-6">
            <div className="service__card">
              <div className="service__img">
        ...
        <div className="joblist__content">
          <div className="joblist__result">
            <div className="result__title">
              <h2>
                Results for {param.keyword ? `"${param.keyword}"` : "..."}
              </h2>
            </div>
            ...
            <div className="result__services">
              <div className="service__content row">{handleRenderList()}</div>
            </div>
